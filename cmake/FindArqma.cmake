...
set(LIBS common;cryptonote_basic;cryptonote_core;
         ...
         blockchain_db;;net;ringct;wallet;cncrypto;easylogging;version;checkpoints)
...
message(STATUS ${ARQMA_SOURCE_DIR}/build/Linux/master)

# include Arqma headers
include_directories(
		${ARQMA_SOURCE_DIR}/src
		${ARQMA_SOURCE_DIR}/external
		${ARQMA_SOURCE_DIR}/build/Linux/master
